  ...
  def main(args: Array[String]): Unit = {
    try {
      ...
      try {
        ...
        var millisecond = 0
        var microsecond = 0
        var nanosecond = 0 // initialize date and time variables

        val era1 = DateTimeFormatter.ofPattern(
          "GGG"
        ...
        try { // make sure date and time input is a valid integer
          ...
          val enteredDateAndTime = LocalDateTime
            .of(year, month, day, hour, minute, second)
            .withNano(
              millisecond * 1000000 + microsecond * 1000 + nanosecond
            ) // Convert datetime of GregorianCalendar object to LocalDateTime object named enteredDateAndTime without a time zone and set nanoseconds to 1,000,000 (1 million) * milliseconds + 1,000 (1 thousand) * microseconds + nanoseconds
          ...
          System.out.println(
            "Era: " + era1.format(enteredDateAndTime) + " (" + era2.format(
              enteredDateAndTime
            ) + ")" + " (" + era3.format(enteredDateAndTime) + ")"
          ) // Print the date and time values with formatted date and time pattern

          System.out.println(
            "Year: " + year1.format(enteredDateAndTime) + " (" + year2.format(
              enteredDateAndTime
            ) + ")"
          )
          System.out.println(
            "Era Year: " + yearEra.format(enteredDateAndTime) + " (" + yearEra2
              .format(enteredDateAndTime) + ")"
          )
          System.out.println(
            "Day of Year: " + dayOfYear.format(enteredDateAndTime)
          )
          System.out.println(
            "Month of Year: " + monthOfYear.format(
              enteredDateAndTime
            ) + " (" + monthOfYear2.format(
              enteredDateAndTime
            ) + ")" + " (" + monthOfYear3.format(
          ...
          System.out.println(
            "Quarter: " + quarter.format(enteredDateAndTime) + " (" + quarter2
              .format(enteredDateAndTime) + ")" + " (" + quarter3.format(
              enteredDateAndTime
            ) + ")"
          )
          System.out.println(
            "ISO Week-based Year: " + weekBasedYear.format(
              enteredDateAndTime
          ...
          System.out.println(
            "Local Day of Week: " + localDayOfWeek.format(
              ...
              enteredDateAndTime
            ) + ")" + " (" + localDayOfWeek3.format(
              enteredDateAndTime
            ) + ")" + " (" + localDayOfWeek4.format(enteredDateAndTime) + ")"
          )
          System.out.println(
            "Local Week of Month: " + localWeekOfMonth.format(
              enteredDateAndTime
            )
          )
          ...
          System.out.println(
            "Time Zone: " + timezoneName2.format(
              enteredDateAndTimeTimezone
            ) + " (" + timezoneName.format(enteredDateAndTimeTimezone) + ")"
          )
          System.out.println(
            "Localized Time Zone Offset: " + timezoneOffset.format(
              enteredDateAndTimeTimezone
            ) + " (" + timezoneOffset2.format(enteredDateAndTimeTimezone) + ")"
          )
          System.out.println(
            "Time Zone Offset: " + timezoneOffsetZ.format(
              enteredDateAndTimeTimezone
            ) + " (" + timezoneOffsetX.format(
              enteredDateAndTimeTimezone
            ) + ")" + " (" + timezoneOffsetZ1.format(
              enteredDateAndTimeTimezone
            ) + ")"
          )
          ...
          case ex: InputMismatchException =>
            // if entered, date and time values are in the wrong format (not a valid integer)
            System.out.println(
        ...
        System.out.println(
          "Current Era: " + era1.format(dateAndTimeNow) + " (" + era2.format(
            dateAndTimeNow
          ) + ")" + " (" + era3.format(dateAndTimeNow) + ")"
        ) // Print the formatted date and time values in current local date and time

        System.out.println(
          "Current Year: " + year1.format(dateAndTimeNow) + " (" + year2.format(
            dateAndTimeNow
          ) + ")"
        )
        System.out.println(
          "Current Era Year: " + yearEra.format(
            dateAndTimeNow
        ...
        System.out.println(
          "Current Month of Year: " + monthOfYear.format(
            dateAndTimeNow
          ) + " (" + monthOfYear2.format(
            dateAndTimeNow
          ) + ")" + " (" + monthOfYear3.format(
        ...
        System.out.println(
          "Current Quarter: " + quarter.format(dateAndTimeNow) + " (" + quarter2
            .format(dateAndTimeNow) + ")" + " (" + quarter3.format(
            dateAndTimeNow
          ) + ")"
        )
        System.out.println(
          "Current ISO Week-based Year: " + weekBasedYear.format(
            dateAndTimeNow
        ...
        System.out.println(
          "Current Local Week of Month: " + localWeekOfMonth.format(
            dateAndTimeNow
          )
        )
        ...
        System.out.println(
          "Current Fraction of Second: " + fractionOfSecond.format(
            dateAndTimeNow
          )
        )
        System.out.println(
        ...
        System.out.println(
          "Current Time Zone: " + timezoneName2.format(
            dateAndTimeNow
          ) + " (" + timezoneName.format(dateAndTimeNow) + ")"
        )
        System.out.println(
          "Current Localized Time Zone Offset: " + timezoneOffset.format(
            dateAndTimeNow
          ) + " (" + timezoneOffset2.format(dateAndTimeNow) + ")"
        )
        System.out.println(
          "Current Time Zone Offset: " + timezoneOffsetZ.format(
            dateAndTimeNow
          ) + " (" + timezoneOffsetX.format(
            dateAndTimeNow
          ) + ")" + " (" + timezoneOffsetZ1.format(dateAndTimeNow) + ")"
        )
        val currentUtcDateAndTime =
          Instant.now // Get the current UTC date and time using an Instant object
        ...
        System.out.println(
          "Current UTC Era: " + era1.format(utcDateAndTimeNow) + " (" + era2
            .format(utcDateAndTimeNow) + ")" + " (" + era3.format(
            utcDateAndTimeNow
          ) + ")"
        ) // Print the formatted date and time values in current local date and time

        System.out.println(
          "Current UTC Year: " + year1.format(utcDateAndTimeNow) + " (" + year2
            .format(utcDateAndTimeNow) + ")"
        )
        System.out.println(
          "Current UTC Era Year: " + yearEra.format(
            utcDateAndTimeNow
        ...
        System.out.println(
          "Current UTC Month of Year: " + monthOfYear.format(
            utcDateAndTimeNow
          ) + " (" + monthOfYear2.format(
            utcDateAndTimeNow
          ) + ")" + " (" + monthOfYear3.format(
        ...
        System.out.println(
          "Current UTC Quarter: " + quarter.format(
            utcDateAndTimeNow
          ) + " (" + quarter2.format(utcDateAndTimeNow) + ")" + " (" + quarter3
            .format(utcDateAndTimeNow) + ")"
        )
        System.out.println(
          "Current UTC ISO Week-based Year: " + weekBasedYear.format(
            utcDateAndTimeNow
        ...
        System.out.println(
          "Current UTC Day of Week: " + dayOfWeek.format(
            utcDateAndTimeNow
          ) + " (" + dayOfWeek2.format(
            utcDateAndTimeNow
        ...
        System.out.println(
          "Current UTC Local Week of Month: " + localWeekOfMonth.format(
            utcDateAndTimeNow
          )
        )
        System.out.println(
        ...
        System.out.println(
          "Current UTC Fraction of Second: " + fractionOfSecond.format(
            utcDateAndTimeNow
          )
        )
        System.out.println(
        ...
        System.out.println(
          "Current UTC Nanosecond: " + nanosecondOfSecond.format(
            utcDateAndTimeNow
          )
        )
        System.out.println(
          "Current UTC Nanosecond of Day: " + nanosecondOfDay.format(
            utcDateAndTimeNow
          )
        )
