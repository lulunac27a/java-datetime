...
public class datetime {
        public static void main(String[] args) {
                ...
                System.out.println("Era: " + era1.format(dateandtime) + " (" + era2.format(dateandtime) + ")" + " (" + era3.format(dateandtime) + ")"); // Print the date and time values with formatted date and time pattern
                ...
                System.out.println("Month of Year: " + monthofyear.format(dateandtime) + " (" + monthofyear2.format(dateandtime) + ")" + " (" + monthofyear3.format(dateandtime) + ")" + " (" + monthofyear4.format(dateandtime) + ")");
                System.out.println("Day of Month: " + dayofmonth.format(dateandtime));
                System.out.println("Quarter: " + quarter.format(dateandtime) + " (" + quarter2.format(dateandtime) + ")" + " (" + quarter3.format(dateandtime) + ")");
                System.out.println("ISO Week-based Year: " + yearweek.format(dateandtime) + " (" + yearweek2.format(dateandtime) + ")");
                ...
                System.out.println("Day of Week: " + dayofweek.format(dateandtime) + " (" + dayofweek2.format(dateandtime) + ")" + " (" + dayofweek3.format(dateandtime) + ")");
                System.out.println("Local Day of Week: " + localdayofweek.format(dateandtime) + " (" + localdayofweek2.format(dateandtime) + ")" + " (" + localdayofweek3.format(dateandtime) + ")" + " (" + localdayofweek4.format(dateandtime) + ")");
                ...
                LocalDateTime dateandtimenow = LocalDateTime.of(year, month, day, hour, minute, second); // Get the current date and time based on local computer date and time
                ...
                System.out.println("Current Era: " + nowera1.format(dateandtimenow) + " (" + nowera2.format(dateandtimenow) + ")" + " (" + nowera3.format(dateandtimenow) + ")"); // Print the formatted date and time values in current local date and time
                System.out.println("Current Year: " + nowyear1.format(dateandtimenow) + " (" + nowyear2.format(dateandtimenow) + ")");
                System.out.println("Current Era Year: " + nowyearera.format(dateandtimenow) + " (" + nowyearera2.format(dateandtimenow) + ")");
                System.out.println("Current Day of Year: " + nowdayofyear.format(dateandtimenow));
                System.out.println("Month of Year: " + nowmonthofyear.format(dateandtimenow) + " (" + nowmonthofyear2.format(dateandtimenow) + ")" + " (" + nowmonthofyear3.format(dateandtimenow) + ")" + " (" + nowmonthofyear4.format(dateandtimenow) + ")");
                System.out.println("Current Day of Month: " + nowdayofmonth.format(dateandtimenow));
                System.out.println("Current Quarter: " + nowquarter.format(dateandtimenow) + " (" + nowquarter2.format(dateandtimenow) + ")" + " (" + nowquarter3.format(dateandtimenow) + ")");
                System.out.println("ISO Week-based Year: " + nowyearweek.format(dateandtimenow) + " (" + nowyearweek2.format(dateandtimenow) + ")");
                ...
                System.out.println("Current Day of Week: " + nowdayofweek.format(dateandtimenow) + " (" + nowdayofweek2.format(dateandtimenow) + ")" + " (" + nowdayofweek3.format(dateandtimenow) + ")");
                System.out.println("Current Local Day of Week: " + nowlocaldayofweek.format(dateandtimenow) + " (" + nowlocaldayofweek2.format(dateandtimenow) + ")" + " (" + nowlocaldayofweek3.format(dateandtimenow) + ")" + " (" + nowlocaldayofweek4.format(dateandtimenow) + ")");
