...
public class datetime {
        public static void main(String[] args) {
                ...
                System.out.println("Era: " + era1.format(dateandtime) + " (" + era2.format(dateandtime) + ")" + " ("
                                + era3.format(dateandtime) + ")"); // Print the date and time values with formatted date
                                                                   // and time pattern
                System.out.println("Year: " + year1.format(dateandtime) + " (" + year2.format(dateandtime) + ")");
                System.out.println(
                                "Era Year: " + yearera.format(dateandtime) + " (" + yearera2.format(dateandtime) + ")");
                ...
                System.out.println("Month of Year: " + monthofyear.format(dateandtime) + " ("
                                + monthofyear2.format(dateandtime) + ")" + " (" + monthofyear3.format(dateandtime) + ")"
                ...
                System.out.println("Day of Week: " + dayofweek.format(dateandtime) + " ("
                                + dayofweek2.format(dateandtime) + ")" + " (" + dayofweek3.format(dateandtime) + ")");
                ...
                LocalDateTime dateandtimenow = LocalDateTime.now(); // Get the current date and time based on local
                                                                    // computer date and time
                DateTimeFormatter nowera1 = DateTimeFormatter.ofPattern("GGG"); // Format the current local date and
                                                                                // time values
                ...
                System.out.println("Current Era: " + nowera1.format(dateandtimenow) + " ("
                                + nowera2.format(dateandtimenow) + ")" + " (" + nowera3.format(dateandtimenow) + ")"); // Print
                                                                                                                       // the
                                                                                                                       // formatted
                                                                                                                       // date
                                                                                                                       // and
