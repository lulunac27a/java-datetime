        ...
        try (Scanner sc = new Scanner(System.in)) {
            ...
            try {// make sure date and time input is a vaild integer
                ...
                System.out.println("Era: " + era1.format(enteredDateAndTime) + " (" + era2.format(enteredDateAndTime)
                        + ")" + " (" + era3.format(enteredDateAndTime) + ")"); // Print the date and time values with
                                                                               // formatted date and time pattern
                System.out.println(
                        "Year: " + year1.format(enteredDateAndTime) + " (" + year2.format(enteredDateAndTime) + ")");
            ...
            System.out.println("Current Era: " + era1.format(dateAndTimeNow) + " (" + era2.format(dateAndTimeNow) + ")"
                    + " (" + era3.format(dateAndTimeNow) + ")"); // Print the formatted date and time values in current
                                                                 // local date and time
            System.out.println(
                    "Current Year: " + year1.format(dateAndTimeNow) + " (" + year2.format(dateAndTimeNow) + ")");
            ...
            LocalDateTime utcDateAndTimeNow = LocalDateTime.ofInstant(currentUtcDateAndTime, ZoneOffset.UTC);// Convert
                                                                                                             // from an
                                                                                                             // Instant
                                                                                                             // object
                                                                                                             // to
            ...
            System.out.println("Current UTC Era: " + era1.format(utcDateAndTimeNow) + " ("
                    + era2.format(utcDateAndTimeNow) + ")" + " (" + era3.format(utcDateAndTimeNow) + ")"); // Print the
                                                                                                           // formatted
                                                                                                           // date and
                                                                                                           // time
                                                                                                           // values in
