...
public class datetime {
    ...
    public static void main(String[] args) {
        try (Scanner sc = new Scanner(System.in)) {
            int year, month, day, hour, minute, second, millisecond, microsecond, nanosecond; // initialize date and
                                                                                              // time variables
            ...
            DateTimeFormatter fractionOfSecond = DateTimeFormatter.ofPattern(
                    "SSSSSSSSS");
            ...
            try { // make sure date and time input is a valid integer
                ...
                LocalDateTime enteredDateAndTime = LocalDateTime
                        ...
                        .withNano(millisecond * 1000000 + microsecond * 1000 + nanosecond); // Convert datetime of
                                                                                            ...
                                                                                            // named enteredDateAndTime
                                                                                            // without a time zone and
                                                                                            // set nanoseconds to
                                                                                            // 1,000,000 (1 million) *
                                                                                            // milliseconds + 1,000 (1
                                                                                            // thousand) * microseconds
                                                                                            // + nanoseconds
                ZonedDateTime enteredDateAndTimeTimezone = ZonedDateTime.of(
                        enteredDateAndTime,
                        ZoneId.systemDefault()); // Get time zone of entered date and time values
                                                 // Print the entered date and time values in all supported formats
                System.out.println("\nEntered Date and Time Values:\n");
                System.out.println(
                        "Era: " +
                                era1.format(enteredDateAndTime) +
                                " (" +
                                era2.format(enteredDateAndTime) +
                                ")" +
                                " (" +
                                era3.format(enteredDateAndTime) +
                                ")"); // Print the date and time values with formatted date and time pattern
                System.out.println(
                        "Year: " +
                                year1.format(enteredDateAndTime) +
                                " (" +
                                year2.format(enteredDateAndTime) +
                                ")");
                System.out.println(
                        "Era Year: " +
                                yearEra.format(enteredDateAndTime) +
                                " (" +
                                yearEra2.format(enteredDateAndTime) +
                                ")");
                System.out.println(
                        "Day of Year: " + dayOfYear.format(enteredDateAndTime));
                System.out.println(
                        "Month of Year: " +
                                monthOfYear.format(enteredDateAndTime) +
                                " (" +
                ...
                System.out.println(
                        "ISO Week-based Year: " +
                                weekBasedYear.format(enteredDateAndTime) +
                                " (" +
                                weekBasedYear2.format(enteredDateAndTime) +
                                ")");
                System.out.println(
                        "Week of Year: " + weekOfYear.format(enteredDateAndTime));
                System.out.println(
                ...
                System.out.println(
                        "Local Day of Week: " +
                                ...
                                ")");
                System.out.println(
                        "Local Week of Month: " + localWeekOfMonth.format(enteredDateAndTime));
                ...
                System.out.println(
                        "Fraction of Second: " + fractionOfSecond.format(enteredDateAndTime));
                System.out.println(
                        "Millisecond of Day: " + millisecondOfDay.format(enteredDateAndTime));
                System.out.println(
                        "Nanosecond: " + nanosecondOfSecond.format(enteredDateAndTime));
                System.out.println(
                        "Nanosecond of Day: " + nanosecondOfDay.format(enteredDateAndTime));
                System.out.println(
                        "Time Zone ID: " + timezoneId.format(enteredDateAndTimeTimezone));
                System.out.println(
                        "Time Zone: " +
                                timezoneName2.format(enteredDateAndTimeTimezone) +
                                " (" +
                                timezoneName.format(enteredDateAndTimeTimezone) +
                                ")");
                System.out.println(
                        "Localized Time Zone Offset: " +
                                timezoneOffset.format(enteredDateAndTimeTimezone) +
                                " (" +
                                timezoneOffset2.format(enteredDateAndTimeTimezone) +
                                ")");
                System.out.println(
                        "Time Zone Offset: " +
                                timezoneOffsetZ.format(enteredDateAndTimeTimezone) +
                                " (" +
            ...
            } catch (InputMismatchException ex) { // if entered, date and time values are in the wrong format (not a
                                                  // valid integer)
                System.out.println(
            ...
            System.out.println(
                    "Current Era: " +
                            ...
                            " (" +
                            era2.format(dateAndTimeNow) +
                            ")" +
                            " (" +
                            era3.format(dateAndTimeNow) +
                            ")"); // Print the formatted date and time values in current local date and time
            System.out.println(
                    "Current Year: " +
                            year1.format(dateAndTimeNow) +
                            " (" +
                            year2.format(dateAndTimeNow) +
                            ")");
            System.out.println(
                    "Current Era Year: " +
                            yearEra.format(dateAndTimeNow) +
                            " (" +
                            yearEra2.format(dateAndTimeNow) +
                            ")");
            System.out.println(
                    "Current Day of Year: " + dayOfYear.format(dateAndTimeNow));
            System.out.println(
                    "Current Month of Year: " +
                            monthOfYear.format(dateAndTimeNow) +
                            " (" +
                            monthOfYear2.format(dateAndTimeNow) +
                            ")" +
                            " (" +
                            monthOfYear3.format(dateAndTimeNow) +
                            ")" +
                            " (" +
            ...
            System.out.println(
                    "Current Quarter: " +
                            ...
                            ")");
            System.out.println(
                    "Current ISO Week-based Year: " +
                            weekBasedYear.format(dateAndTimeNow) +
                            " (" +
                            weekBasedYear2.format(dateAndTimeNow) +
                            ")");
            System.out.println(
                    "Current Week of Year: " + weekOfYear.format(dateAndTimeNow));
            System.out.println(
            ...
            System.out.println(
                    "Current Day of Week: " +
                            ...
                            ")" +
                            " (" +
                            dayOfWeek3.format(dateAndTimeNow) +
                            ")");
            System.out.println(
                    "Current Local Day of Week: " +
                            ...
                            ")");
            System.out.println(
                    "Current Local Week of Month: " +
                            localWeekOfMonth.format(dateAndTimeNow));
            ...
            System.out.println(
                    "Current Fraction of Second: " + fractionOfSecond.format(dateAndTimeNow));
            System.out.println(
                    "Current Millisecond of Day: " + millisecondOfDay.format(dateAndTimeNow));
            System.out.println(
                    "Current Nanosecond: " + nanosecondOfSecond.format(dateAndTimeNow));
            System.out.println(
                    "Current Nanosecond of Day: " + nanosecondOfDay.format(dateAndTimeNow));
            System.out.println(
                    "Current Time Zone ID: " + timezoneId.format(dateAndTimeNow));
            System.out.println(
                    "Current Time Zone: " +
                            timezoneName2.format(dateAndTimeNow) +
                            " (" +
                            timezoneName.format(dateAndTimeNow) +
                            ")");
            System.out.println(
                    "Current Localized Time Zone Offset: " +
                            timezoneOffset.format(dateAndTimeNow) +
                            " (" +
                            timezoneOffset2.format(dateAndTimeNow) +
                            ")");
            System.out.println(
                    "Current Time Zone Offset: " +
                            timezoneOffsetZ.format(dateAndTimeNow) +
                            " (" +
                            timezoneOffsetX.format(dateAndTimeNow) +
                            ")" +
                            " (" +
            ...
            LocalDateTime utcDateAndTimeNow = LocalDateTime.ofInstant(
                    currentUtcDateAndTime,
                    ZoneOffset.UTC); // Convert from an Instant object to LocalDateTime object
            System.out.println(
                    "Current UTC Era: " +
                            era1.format(utcDateAndTimeNow) +
                            " (" +
                            era2.format(utcDateAndTimeNow) +
                            ")" +
                            " (" +
                            era3.format(utcDateAndTimeNow) +
                            ")"); // Print the formatted date and time values in current local date and time
            System.out.println(
                    "Current UTC Year: " +
                            year1.format(utcDateAndTimeNow) +
                            " (" +
                            year2.format(utcDateAndTimeNow) +
                            ")");
            System.out.println(
                    "Current UTC Era Year: " +
                            yearEra.format(utcDateAndTimeNow) +
                            " (" +
                            yearEra2.format(utcDateAndTimeNow) +
                            ")");
            System.out.println(
                    "Current UTC Day of Year: " + dayOfYear.format(utcDateAndTimeNow));
            System.out.println(
                    "Current UTC Month of Year: " +
                            monthOfYear.format(utcDateAndTimeNow) +
                            " (" +
                            ...
                            ")");
            System.out.println(
                    "Current UTC Day of Month: " + dayOfMonth.format(utcDateAndTimeNow));
            System.out.println(
                    "Current UTC Quarter: " +
                            quarter.format(utcDateAndTimeNow) +
                            " (" +
                            quarter2.format(utcDateAndTimeNow) +
                            ")" +
                            " (" +
                            quarter3.format(utcDateAndTimeNow) +
                            ")");
            System.out.println(
                    "Current UTC ISO Week-based Year: " +
                            weekBasedYear.format(utcDateAndTimeNow) +
                            " (" +
                            weekBasedYear2.format(utcDateAndTimeNow) +
                            ")");
            System.out.println(
                    "Current UTC Week of Year: " + weekOfYear.format(utcDateAndTimeNow));
            System.out.println(
                    "Current UTC Week of Month: " + weekOfMonth.format(utcDateAndTimeNow));
            System.out.println(
                    "Current UTC Day of Week: " +
                            dayOfWeek.format(utcDateAndTimeNow) +
                            " (" +
                            dayOfWeek2.format(utcDateAndTimeNow) +
                            ")" +
                            " (" +
            ...
            System.out.println(
                    "Current UTC Local Day of Week: " +
                            ...
                            ")");
            System.out.println(
                    "Current UTC Local Week of Month: " +
                            localWeekOfMonth.format(utcDateAndTimeNow));
            System.out.println(
            ...
            System.out.println(
                    "Current UTC Minute: " + minute1.format(utcDateAndTimeNow));
            System.out.println(
                    "Current UTC Second: " + second1.format(utcDateAndTimeNow));
            System.out.println(
                    "Current UTC Fraction of Second: " +
                            fractionOfSecond.format(utcDateAndTimeNow));
            System.out.println(
                    "Current UTC Millisecond of Day: " +
                            millisecondOfDay.format(utcDateAndTimeNow));
            System.out.println(
                    "Current UTC Nanosecond: " +
                            nanosecondOfSecond.format(utcDateAndTimeNow));
            System.out.println(
                    "Current UTC Nanosecond of Day: " +
                            nanosecondOfDay.format(utcDateAndTimeNow));
        }
    }
}
