...
public class datetime {
  public static void main(String[] args) {
    ...
    GregorianCalendar datetime = new GregorianCalendar(
        year, month, day, hour, minute, second); // Get the date and
                                                 // time values based
                                                 // on user entered
                                                 // input
    LocalDateTime dateandtime = LocalDateTime.of(
        year, month, day, hour, minute, second); // Convert datetime
                                                 // GregorianCalendar
                                                 // object to
                                                 // LocalDateTime object
                                                 // named dateandtime
    DateTimeFormatter era1 =
        DateTimeFormatter.ofPattern("GGG"); // Format the date and time values
    ...
    DateTimeFormatter fractionofsecond =
    ...
    System.out.println("Era: " + era1.format(dateandtime) + " (" +
                       era2.format(dateandtime) + ")"
                       + " (" + era3.format(dateandtime) +
                       ")"); // Print the date and time values with formatted
                             // date and time units

    System.out.println("Year: " + year1.format(dateandtime) + " (" +
                       year2.format(dateandtime) + ")");
    System.out.println("Era Year: " + yearera.format(dateandtime) + " (" +
                       yearera2.format(dateandtime) + ")");
    System.out.println("Day of Year: " + dayofyear.format(dateandtime));
    System.out.println("Month of Year: " + monthofyear.format(dateandtime) +
                       " (" + monthofyear2.format(dateandtime) + ")"
                       + " (" + monthofyear3.format(dateandtime) + ")"
                       + " (" + monthofyear4.format(dateandtime) + ")");
    System.out.println("Day of Month: " + dayofmonth.format(dateandtime));
    System.out.println("Quarter: " + quarter.format(dateandtime) + " (" +
                       quarter2.format(dateandtime) + ")"
                       + " (" + quarter3.format(dateandtime) + ")");
    System.out.println("ISO Week-based Year: " + yearweek.format(dateandtime) +
                       " (" + yearweek2.format(dateandtime) + ")");
    ...
    System.out.println("Day of Week: " + dayofweek.format(dateandtime) + " (" +
                       dayofweek2.format(dateandtime) + ")"
                       + " (" + dayofweek3.format(dateandtime) + ")");
    System.out.println(
        "Local Day of Week: " + localdayofweek.format(dateandtime) + " (" +
        localdayofweek2.format(dateandtime) + ")"
        + " (" + localdayofweek3.format(dateandtime) + ")"
        + " (" + localdayofweek4.format(dateandtime) + ")");
    System.out.println("Local Week of Month: " +
                       localweekofmonth.format(dateandtime));
    ...
    System.out.println("Fraction of Second: " +
                       fractionofsecond.format(dateandtime));
    ...
    LocalDateTime dateandtimenow = LocalDateTime.of(
        year, month, day, hour, minute, second); // Get the current date
                                                 // and time based on
                                                 // computer time
    DateTimeFormatter nowera1 = DateTimeFormatter.ofPattern(
        "GGG"); // Format the current date and time values
    ...
    DateTimeFormatter nowfractionofsecond =
        DateTimeFormatter.ofPattern("SSSSSSSSS");
    ...
    System.out.println("Current Era: " + nowera1.format(dateandtimenow) + " (" +
                       nowera2.format(dateandtimenow) + ")"
                       + " (" + nowera3.format(dateandtimenow) +
                       ")"); // Print the formatted date and time values in
                             // current date and time

    System.out.println("Current Year: " + nowyear1.format(dateandtimenow) +
                       " (" + nowyear2.format(dateandtimenow) + ")");
    System.out.println(
        "Current Era Year: " + nowyearera.format(dateandtimenow) + " (" +
        nowyearera2.format(dateandtimenow) + ")");
    System.out.println("Current Day of Year: " +
                       nowdayofyear.format(dateandtimenow));
    System.out.println(
    ...
    System.out.println("Current Day of Month: " +
                       nowdayofmonth.format(dateandtimenow));
    ...
    System.out.println("Current Week of Year: " +
                       nowweekyear.format(dateandtimenow));
    System.out.println("Current Week of Month: " +
                       nowweekofmonth.format(dateandtimenow));
    System.out.println(
        "Current Day of Week: " + nowdayofweek.format(dateandtimenow) + " (" +
        nowdayofweek2.format(dateandtimenow) + ")"
        + " (" + nowdayofweek3.format(dateandtimenow) + ")");
    System.out.println("Current Local Day of Week: " +
                       nowlocaldayofweek.format(dateandtimenow) + " (" +
                       nowlocaldayofweek2.format(dateandtimenow) + ")"
                       + " (" + nowlocaldayofweek3.format(dateandtimenow) + ")"
                       + " (" + nowlocaldayofweek4.format(dateandtimenow) +
                       ")");
    System.out.println("Current Local Week of Month: " +
                       nowlocalweekofmonth.format(dateandtimenow));
    System.out.println("Current AM/PM: " + nowampm.format(dateandtimenow));
    System.out.println("Current 12 Hour Format " +
                       nowhour12.format(dateandtimenow));
    System.out.println("Current 0-11 Hour Format: " +
                       nowhour011.format(dateandtimenow));
    System.out.println("Current 24 Hour Format: " +
                       nowhour24.format(dateandtimenow));
    System.out.println("Current Hour of Day: " +
                       nowhourofday.format(dateandtimenow));
    ...
    System.out.println("Current Fraction of Second: " +
                       nowfractionofsecond.format(dateandtimenow));
    System.out.println("Current Millisecond of Day: " +
                       nowmilliofday.format(dateandtimenow));
    System.out.println("Current Nanosecond: " +
                       nownanoofsecond.format(dateandtimenow));
    System.out.println("Current Nanosecond of Day: " +
                       nownanoofday.format(dateandtimenow));
  }
}
