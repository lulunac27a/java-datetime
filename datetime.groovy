    ...
    static void main(String[] args) {
        try (Scanner sc = new Scanner(System.in)) {
            ...
            try { //make sure date and time input is a valid integer
                ...
                System.out.println('Day of the Month: ' + dayOfMonth.format(enteredDateAndTime))
                ...
                System.out.println('Day of the Week: ' + dayOfWeek.format(enteredDateAndTime) + ' (' + dayOfWeek2.format(enteredDateAndTime) + ')' + ' (' + dayOfWeek3.format(enteredDateAndTime) + ')')
                System.out.println('Local Day of the Week: ' + localDayOfWeek.format(enteredDateAndTime) + ' (' + localDayOfWeek2.format(enteredDateAndTime) + ')' + ' (' + localDayOfWeek3.format(enteredDateAndTime) + ')' + ' (' + localDayOfWeek4.format(enteredDateAndTime) + ')')
            ...
            System.out.println('Current Day of the Month: ' + dayOfMonth.format(dateAndTimeNow))
