    ...
    static void main(String[] args) {
        try (Scanner sc = new Scanner(System.in)) {
            ...
            try { //make sure date and time input is a valid integer
                ...
                System.out.println('Era Year: ' + yearEra.format(enteredDateAndTime) + ' (' + yearEra2.format(enteredDateAndTime) + ')')
                System.out.println('Day of Year: ' + dayOfYear.format(enteredDateAndTime))
                System.out.println('Month of Year: ' + monthOfYear.format(enteredDateAndTime) + ' (' + monthOfYear2.format(enteredDateAndTime) + ')' + ' (' + monthOfYear3.format(enteredDateAndTime) + ')' + ' (' + monthOfYear4.format(enteredDateAndTime) + ')')
                System.out.println('Day of Month: ' + dayOfMonth.format(enteredDateAndTime))
                System.out.println('Quarter: ' + quarter.format(enteredDateAndTime) + ' (' + quarter2.format(enteredDateAndTime) + ')' + ' (' + quarter3.format(enteredDateAndTime) + ')')
                System.out.println('ISO Week-based Year: ' + weekBasedYear.format(enteredDateAndTime) + ' (' + weekBasedYear2.format(enteredDateAndTime) + ')')
                ...
                System.out.println('Day of Week: ' + dayOfWeek.format(enteredDateAndTime) + ' (' + dayOfWeek2.format(enteredDateAndTime) + ')' + ' (' + dayOfWeek3.format(enteredDateAndTime) + ')')
                System.out.println('Local Day of Week: ' + localDayOfWeek.format(enteredDateAndTime) + ' (' + localDayOfWeek2.format(enteredDateAndTime) + ')' + ' (' + localDayOfWeek3.format(enteredDateAndTime) + ')' + ' (' + localDayOfWeek4.format(enteredDateAndTime) + ')')
                ...
                System.out.println('Time Zone: ' + timezoneName2.format(enteredDateAndTimeTimezone) + ' (' + timezoneName.format(enteredDateAndTimeTimezone) + ')')
                ...
                System.out.println('Time Zone Offset: ' + timezoneOffsetZ.format(enteredDateAndTimeTimezone) + ' (' + timezoneOffsetX.format(enteredDateAndTimeTimezone) + ')' + ' (' + timezoneOffsetZ1.format(enteredDateAndTimeTimezone) + ')')
            ...
            System.out.println('Current Era Year: ' + yearEra.format(dateAndTimeNow) + ' (' + yearEra2.format(dateAndTimeNow) + ')')
            System.out.println('Current Day of Year: ' + dayOfYear.format(dateAndTimeNow))
            System.out.println('Current Month of Year: ' + monthOfYear.format(dateAndTimeNow) + ' (' + monthOfYear2.format(dateAndTimeNow) + ')' + ' (' + monthOfYear3.format(dateAndTimeNow) + ')' + ' (' + monthOfYear4.format(dateAndTimeNow) + ')')
            System.out.println('Current Day of Month: ' + dayOfMonth.format(dateAndTimeNow))
            System.out.println('Current Quarter: ' + quarter.format(dateAndTimeNow) + ' (' + quarter2.format(dateAndTimeNow)  + ')' + ' (' + quarter3.format(dateAndTimeNow) + ')')
            ...
            System.out.println('Current Day of Week: ' + dayOfWeek.format(dateAndTimeNow) + ' (' + dayOfWeek2.format(dateAndTimeNow) + ')' + ' (' + dayOfWeek3.format(dateAndTimeNow) + ')')
            System.out.println('Current Local Day of Week: ' + localDayOfWeek.format(dateAndTimeNow) + ' (' + localDayOfWeek2.format(dateAndTimeNow) + ')' + ' (' + localDayOfWeek3.format(dateAndTimeNow) + ')' + ' (' + localDayOfWeek4.format(dateAndTimeNow) + ')')
            ...
            System.out.println('Current UTC Quarter: ' + quarter.format(utcDateAndTimeNow) + ' (' + quarter2.format(utcDateAndTimeNow) + ')' + ' (' + quarter3.format(utcDateAndTimeNow) + ')')
            ...
            System.out.println('Current UTC Local Day of Week: ' + localDayOfWeek.format(utcDateAndTimeNow) + ' (' + localDayOfWeek2.format(utcDateAndTimeNow) + ')' + ' (' + localDayOfWeek3.format(utcDateAndTimeNow) + ')' + ' (' + localDayOfWeek4.format(utcDateAndTimeNow) + ')')
